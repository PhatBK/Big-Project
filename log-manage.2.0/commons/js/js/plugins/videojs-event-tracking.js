...
var BufferInfiniteTracking = function BufferInfiniteTracking(config) {
    ...
    var reset = function reset() {
        ...
        timeBufferInfinite = 0;
        waitFlag = false;
        timeUpdateFlas = false;
    }
}
// theo sự kiện khi người dùng xem hết video hoặc player bị đóng
var FinishedPlayerTracking = function FinishedPlayerTracking(config) {
