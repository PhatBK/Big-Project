...
var PlaylistMenuItem = function (_Component) {
  ...
  PlaylistMenuItem.prototype.createEl = function createEl() {
	...
	// Index
	var indexE1 = document_1.createElement('span');

	indexE1.className = 'vjs-playlist-index-text';
	indexE1.appendChild(document_1.createTextNode(item.index));
	indexE1.setAttribute('title', item.index);
	li.appendChild(indexE1);
	...
	// Delete button
	if (item.delete_class && item.delete_url) {
		var deleteE1 = document_1.createElement('span');
		deleteE1.setAttribute('data-delete-url', item.delete_url);
		deleteE1.className = item.delete_class;
		li.appendChild(deleteE1);
	}

    // Now playing
    var nowPlayingEl = document_1.createElement('span');
    var nowPlayingText = this.localize('Đang phát');
    ...
    var upNextText = this.localize('Phát tiếp theo');

    upNextEl.className = 'vjs-up-next';
...
*/
	...
	var authorEl = document_1.createElement('cite');
	var titleText = item.name || this.localize('Video chưa có tên');
	...
	authorEl.className = 'vjs-playlist-author';
	authorEl.appendChild(document_1.createTextNode(authorText));
	authorEl.setAttribute('title', titleText);
	titleContainerEl.appendChild(authorEl);
