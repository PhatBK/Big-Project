...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 21, 2019 lúc 10:10 AM
...
(37, 'Salad dưa leo rắc trứng', '483_0.jpg', 'Thay vì làm salad theo kiểu thông thường, bạn thử thay đổi một chút trong cách trang trí món salad mang lại món ăn mới lạ mắt ngon miệng hấp dẫn hơn.', 'Dưa leo, 3 trái. Trứng gà, 1 quả.', 'Thanh cua, 3 cây. Hành tây, 1 củ. Bắp hột, 10 gr.', 'Sốt Mayonnaise, 3 muỗng canh. Nước cốt chanh, 1 muỗng canh. Mật ong, 1 muỗng canh.', 'Dễ', 3, 25, 32, 0, NULL, 8, 22, 14, 9, '2017-12-09 03:42:53', '2019-04-11 15:55:51'),
(38, 'Salad khoai tây kiểu Hàn', '510_0.jpg', 'Salad khoai tây kiểu Hàn mềm mịn, vị béo ngậy hấp dẫn. Nếu đã thử nhiều món salad khoai tây rồi thì đây có thể là thêm 1 gợi ý lý tưởng cho bạn đấy nhé!', 'Khoai tây, 500 gr. Trứng gà, 3 quả.', 'Dưa leo, 1 trái.', 'Tiêu, 1/4 muỗng cà phê. Sốt Mayonnaise, 120 gr. Muối, 1/2 muỗng cà phê.', 'Dễ', 5, 30, 12, 0, NULL, 8, 22, 14, 10, '2017-12-09 03:47:08', '2019-04-09 03:41:00'),
(39, 'Cá chép sốt chua ngọt', '764_0.jpg', 'Món cá sốt chua ngọt kiểu này ăn với cơm đậm đà vô cùng. Mặc dù cũng sử dụng các nguyên liệu thân quen, nhưng khi bạn cho thêm một chút thịt băm vào rim cùng sẽ góp phần làm cho món ăn thên đậm vị hơn. Món này mà ăn với cơm nóng thì hao cơm lắm đấy.', 'Cá chép, 500 gr. Thịt heo bằm, 250 gr. Dưa cải chua, 60 gr.', 'Dầu ăn, 50 ml. Nước tương, 10 ml. Rượu trắng, 10 ml.', 'Muối, 5 gr. Ớt, 1 trái. Tỏi, 3 tép. Gừng, 1 miếng. Đường trắng, 8 gr.', 'Trung bình', 4, 35, 15, 0, NULL, 7, 32, 16, 12, '2017-12-09 03:54:44', '2019-04-09 16:55:25'),
...
(1, 'Nhà Hàng Thập Cẩm  Phố Huế', 'nha-hang-thap-cam-pho-hue', 'phohue', '$2y$10$d9IQaq670i13u7fQVTFREuIZ4A1DRcYziXfrJ9KuCf1JzHzs0kfEO', 16, '- sdt : 0123456789\r\n- skype: phohue@outlook.com', '357 Phố Huế,Hai Bà Trưng ,Hà Nội', NULL, 'uploads/customer/avatar/z0Gp15-10ngam-nhin-bo-anh-dep-thien-nhien-moi-ngay4.jpg', 0, 'Eh5xodf2KtmcAnCm321qchU3Q7P6jDtAqTQxOfENQEGxLV85QfyeWiDeHVbt', '2017-12-06 15:43:12', '2019-04-10 12:36:30', 3, '23:10:00', '23:10:00'),
(2, 'Nhà Hàng Bạch Mai', 'nha-hang-bach-mai', 'bachmai.com', '$2y$10$C3W9.BpYC0AL2p9PHT8s1.6HyfhL9vIGjlayd.BLRMCwUpvPeQvb6', 19, '2222222222222222\r\n2222222222222222\r\n2222222222222222', '357 Bạch Mai,Hai Bà Trưng,Hà Nội', NULL, 'uploads/customer/avatar/nKPG68472263-circuit-wallpapers.jpg', 0, 'u3IzrOWj3dA1cuVZa6JICLfhDcmW5G4PX5SBsDgtQUXMhCWtNn2usInVPtBp', '2017-12-06 15:49:04', '2019-04-09 02:18:25', 3, '07:30:00', '21:30:00'),
...
(3659, 'Vịt nấu giả cầy béo ngon', 'uploads/nhahang/u4Mv0.jpg', 'Vịt nấu giả cầy béo ngon với thịt vịt mềm thơm, không hôi, ngấm đều gia vị sả, mẻ, mắm tôm, ... Món vịt giả cầy này có thể giúp cả nhà ăn trong ngày lạnh thì tuyệt.', 250000, 40000, 5, 62, 'Không', 2, '2017-12-16 07:33:29', '2019-04-09 01:44:45'),
...
(5530, 'Cá suối Bắc Giang', 'uploads/nhahang/ZQvDbchdcdhbc.jpg', 'Hôm nay ăn món này', 560000, 90000, 2, 13, 'Có', 1, '2017-12-11 16:03:29', '2019-04-09 03:50:45'),
...
(8231, 'Bà ba nấu nước dừa', 'uploads/nhahang/jfcbdevops.jpg', 'Không thể tín nổi', 1050000, 0, 6, 9, 'Không', 1, '2017-12-15 12:28:22', '2019-04-10 12:36:22'),
...
(25584, 'Tôm sốt chanh dây', 'uploads/nhahang/KcIl0.jpg', 'Tôm sốt chanh dây vị chua thanh đặc trưng của chanh dây ngấm đều vào trong thịt tôm chiên tạo ra món ăn đưa cơm hấp dẫn. Có thể dùng món này chóng ngán và thay đổi khẩu vị cho cả nhà nhé!', 230000, 0, NULL, 7, NULL, 2, '2017-12-16 07:31:36', '2019-04-09 02:18:25'),
...
(1, 'Nguyễn Huy Phát', 'Nam', 21, 'ký sư hệ thống thông tin', 'phatbk11081996@gmail.com', 'team13', '$2y$10$.qE5BWJFPt1kCuxIvy/p3eBmGiHv0uM.9v2Oek9Os2VdFI75QGTM6', 1, 60, 'uploads/customer/avatar/67v518519483_997006177069072_938937820993189642_n.png', NULL, NULL, 'FtGK8Fh1b0Ukc2DtZyAx4c6qcoGzfAHwAC9nLP41UYww4p5wpEXNBUa94Ayd', '2017-11-30 01:44:31', '2017-11-30 01:44:31'),
...
(27, 'Hoàng Văn Hậu', 'Không Xác Định', 21, 'sinh viên', 'hauhoang@gmail.com', 'hauhoang', '$2y$10$05luSiT9OtQQIZ6DvrI1YuRQzRMWB2wYPKPKugYP.Pnm31jdO1Lg6', 2, 58, 'uploads/customer/avatar/Qsng17426226_1324075811019127_1515828002267935521_n.jpg', NULL, NULL, '18HMQmsWseny66E61WuEOH1BVmg3Uq27wpvZ4wWeGhhYHWZGMWjTfgOFV855', '2017-12-19 11:58:24', '2017-12-19 11:58:24'),
(28, 'Nguyễn Thu Hà San', 'Nữ', 21, 'không biết', 'hanguyen@gmail.com', 'hasan', '$2y$10$npl/DkbUmdGlRR0SvtCM5Or7sd63JxLNqKk3bvoZjq/j7HqpAYbpW', 2, 8, 'uploads/customer/avatar/09n0DBSNKF0XoAATrjh.jpg', NULL, NULL, 'e95VaJd8YS8akhelzoguNvnv2BM5DL2M5TnbNfA4tFiikRxybFCZElSZm7jF', '2017-12-19 12:54:25', '2017-12-19 12:54:25'),
...
INSERT INTO `user_implicts_data` (`id`, `user_id`, `mon_an_id`, `mon_an_id_referrer`, `visited_time`, `play_video`, `ip_address`, `anonymouse`, `date_visit`, `time_visit_start`, `created_at`, `updated_at`) VALUES
(53, 27, 58, 31, 900, 0, '127.0.0.1', 0, '2019-04-21', '14:22:16', '2019-04-21 07:22:16', '2019-04-21 07:22:16');
...
ALTER TABLE `survey_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_user_id_for_survey` (`user_id`);
...
ALTER TABLE `user_implicts_data`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_user_id_for_behavior` (`user_id`),
  ADD KEY `2019_mon_an_id_behavior` (`mon_an_id`);
...
ALTER TABLE `user_search_key`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_user_id_for` (`user_id`),
  ADD KEY `2019_mon_an_id` (`mon_an_id`);
...
--
-- Các ràng buộc cho bảng `survey_user`
--
ALTER TABLE `survey_user`
  ADD CONSTRAINT `2019_user_id_for_survey` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Các ràng buộc cho bảng `user_implicts_data`
--
ALTER TABLE `user_implicts_data`
  ADD CONSTRAINT `2019_mon_an_id_behavior` FOREIGN KEY (`mon_an_id`) REFERENCES `monan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `2019_user_id_for_behavior` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `user_search_key`
--
ALTER TABLE `user_search_key`
  ADD CONSTRAINT `2019_mon_an_id` FOREIGN KEY (`mon_an_id`) REFERENCES `monan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `2019_user_id_for` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
